function [fignum] = Eckland_Clay_FigureTrapCapSed(data5clay,calc5clay,fignum)
...
sgtitle('RATTES modeled capacity (clay), sediment volume, and trap efficiency', ...
