RATTES3_readme - this code completes the modeling for the endmember scenario assuming all sand sediment.  The ModelComboAnalysis_Aug2025sand.m code includes 5 functions: CombineMLRSY.m, CompareSY_MLRAug25.m, DeltaTerm.m, RiverSedDAinput.m, SDArivers.m
...
You will need to add MLR input files... adding the prefix mlr from RATTES2 output. The prefix is added to differentiate with final model results:
 (example: mlr_cap_rattes_v1p1_sand.csv) 
