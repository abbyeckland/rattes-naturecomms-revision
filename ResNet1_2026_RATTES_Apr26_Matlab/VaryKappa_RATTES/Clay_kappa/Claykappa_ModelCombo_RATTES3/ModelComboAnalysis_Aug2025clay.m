...
load('../Claykappa_SYModel_MLRinput_RATTES_1/SYModelResults_MLRinput_clay.mat')


loadresults2="no"; %load final results if don't need to rerun
if loadresults2=="yes"
    load FinalRATTESclay.mat
    clear loadresults2;
    return
end
clear loadresults2;
%% setup
inputdateMLR='rattes_v1p1_clay'; %received 04/28/2026  
...
calc1clay=calc1all_wrivers;
calc2clay=calc2_MLRinput;
calc3clay=calc3_SY1;
calc4clay=calc4_SY2;
calc5clay=calc5all;
calc6clay=calc6_delta;
data1clay=data1wrivers;
data2clay=data2norivers;
data3clay=data3SYmodel;
data4clay=data4SYmodel;
data5clay=data5all;
data6clay=data6_delta;
...
save('FinalRATTESclay.mat','-v7.3');
save('RATTESclay5outputs_datacalc.mat','calc5clay','data5clay','-v7.3');
